...
const Projects = () => {
  return (
   <>
   <h1 id="projects" className="text-2xl mt-[100px] text-center">Full Stack Projects</h1>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
        ...
        <div class="card bg-slate-900 text-white shadow-xl p-2">
          ...
          <div class="card-body">
            ...
            <p>This is a full stack project made with HTML5, CSS3, TailwindCSS, React, Node.js, Express.js and Mongodb</p>
            <a href="https://inventory-management-11-9b48e.web.app/" className="btn btn-warning btn-sm w-[40%] ml-auto">Live site</a>
          </div>
        </div>
        <div class="card bg-slate-900 text-white shadow-xl p-2">
          <figure>
