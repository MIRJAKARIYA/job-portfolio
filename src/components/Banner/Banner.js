...
const Banner = () => {
    return (
        <div className='w-[95%] md:w-[80%] mx-auto mt-10'>
            <h1 data-aos="fade-right" className='lg:text-3xl text-xl font-semibold'>HELLO THERE!</h1>
            <h1 className='lg:text-5xl text-3xl font-bold mt-2'>I'M <span className='text-yellow-600'>MIR JAKARIYA</span></h1>
